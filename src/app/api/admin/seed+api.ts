 ...
 * Guarded: a seed endpoint must never be openly writable, so it only runs in dev or with the admin
 * token. This is scaffolding for the migration, not a public route.
 */
